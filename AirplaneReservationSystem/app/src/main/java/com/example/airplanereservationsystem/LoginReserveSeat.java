...
public class LoginReserveSeat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_reserve_seat);

        getSupportActionBar().setTitle("Login");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        username = findViewById(R.id.ReserveSeatLoginUsername);
        password = findViewById(R.id.ReserveSeatLoginPassword);
        loginBtn = findViewById(R.id.ReserveSeatLoginButton);
    ...
    private void login(){
        ...
        if(account != null){
            if(account.getPassword().equals(passwordString)) {
                ReserveSeat.currUser = usernameString;
